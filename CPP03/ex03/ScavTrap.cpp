...
/*   Updated: 2022/02/11 01:24:32 by tkim             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(std::string name):ClapTrap(name), guard_mode(false)
{
	...
	this->energy_points = 50;
	this->attack_damage = 20;
	std::cout << "ScavTrap name constructor called name = " << name << std::endl;
}

ScavTrap::~ScavTrap()
{
	std::cout << "ScavTrap Destructor called name = " << name << std::endl;

}

ScavTrap::ScavTrap(ScavTrap const& scav):ClapTrap(scav), guard_mode(false)
{
	std::cout << "ScavTrap Copy constructor called name = " << name << std::endl;
}
